...
export const TapPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full min-h-0 overflow-y-auto no-scrollbar select-none bg-[#FAF8F5]" style={{ paddingBottom: 'calc(80px + max(env(safe-area-inset-bottom, 0px), 8px))' }}>
      ...
      <div className="shrink-0 flex flex-col px-3 pt-1 pb-2">
        <button
          type="button"
